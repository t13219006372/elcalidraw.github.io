...
import type { ArticleInfoData } from 'vuepress-theme-hope/shared/blog'
...
const { ['t' /* ArticleInfoType.title */]: title, ['e' /* ArticleInfoType.excerpt */]: excerpt } = articleInfo.value
