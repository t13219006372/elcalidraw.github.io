  ...
  <div id="BingSwitchWrapper">
    <a :href="bingData.copyrightlink" target="_Blank" id="bingLink" v-if="bingData">
      <div class="bingLink-icon">
        <svg class="mapPin" height="16" width="16" viewBox="0 0 12 12" aria-hidden="true" role="presentation">
...
const title = computed(() => {
  if (props.bingData.copyright != undefined) {
    ...
    return index != -1 ? props.bingData.copyright.substring(0, index) : props.bingData.copyright
  }
