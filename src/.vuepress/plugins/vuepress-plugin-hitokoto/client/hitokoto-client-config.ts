  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const loopShow = () => {
        ...
        let span: HTMLSpanElement | null = document.getElementById('hitokoto_text') as HTMLSpanElement
        let div: HTMLDivElement | null = document.getElementById('hitokoto_author') as HTMLDivElement
